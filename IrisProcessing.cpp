...
void FileSelector::readFile(bool flag_train){
    ...
    if (flag_train){
        for(fileCount=1; fileCount < fileCountLeft; fileCount++){
            ...
            leftImagefile << "/home/chinmay/Downloads/iris/S1001L" << std::setfill('0') << std::setw(2) << fileCount << ".jpg";
        ...
        for(fileCount=1; fileCount < fileCountRight; fileCount++){
            ...
            rightImagefile << "/home/chinmay/Downloads/iris/S1001R" << std::setfill('0') << std::setw(2) << fileCount << ".jpg";
    ...
    {
        string testFile = "/home/chinmay/Downloads/iris/S1001L10.jpg";
...
void FileSelector::pupilSegmentation(Mat actualImage){		
        ...
        tempMoment2 << "/home/chinmay/Downloads/iris/iris_unwrapped/" << item;
